...
class ZafarEOAlgorithmBase(Algorithm):
    ...
    def run(self, train_df, test_df, class_attr, positive_class_val, sensitive_attrs,
        ...
        result = subprocess.run(cmd,
            cwd='./algorithms/zafar/fair-classification-master/disparate_mistreatment/run-classifier/')
...
class ZafarEOAlgorithmBaseline(ZafarEOAlgorithmBase):

    def __init__(self):
        ZafarEOAlgorithmBase.__init__(self)
        self.name = "ZafarEOBaseline"
...
class ZafarEOAlgorithmOpp(ZafarEOAlgorithmBase):

    def __init__(self):
        ZafarEOAlgorithmBase.__init__(self)
        self.name = "ZafarEqOpp"
...
class ZafarEOAlgorithmOdd(ZafarEOAlgorithmBase):

    def __init__(self):
        ZafarEOAlgorithmBase.__init__(self)
        self.name = "ZafarEqOdds"
