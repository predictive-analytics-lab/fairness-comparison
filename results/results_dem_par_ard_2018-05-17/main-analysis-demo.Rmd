...
algos_to_plot = c(
  "SVM", "GP", "ZafarFairness", "ZafarAccuracy", "FairGPdemo", "FairGPdemo*")
...
make_scatter_figure = function(name, var1="race-TPRDiff", var2="accuracy", algos=algos_to_plot, display="off", statistic = "off") {
  ...
  # df$algorithm <- revalue(df$algorithm, c("FairGPdemo"="FairGPparity"))
  # df$algorithm <- revalue(df$algorithm, c("FairGPdemo*"="FairGPparity*"))
...
for (i in 1:N_file) {
  ...
  print(q)
  export_name = paste(file_name[i], "_demo.eps", sep="")
