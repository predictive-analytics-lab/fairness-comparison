...
algos_to_plot = c(
  ...
  "Feldman-DecisionTree", "Kamishima","UniversalGP")
...
## Algorithm accuracy vs fairness

```{r}
make_scatter_figure = function(name, var1="CV", var2="accuracy", display=0) {
  x_var = as.name(var1)
  y_var = as.name(var2)
  
  df = read.csv(str_c(name, "_numerical-binsensitive.csv"), check.names=TRUE) %>% 
    filter(algorithm %in% algos_to_plot) %>% 
    mutate(algorithm=recode(algorithm, ZafarFairness="Zafar")) # rename to Zafar for clarity
  
  # Scatterplot
  if(display==0){
    ggplot(df, aes_q(x=x_var, y=y_var, colour=quote(algorithm))) + geom_point() + 
...
q_CV = make_scatter_figure("adult_race", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("adult_race", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/adult_race_fair.png", q)

q_CV = make_scatter_figure("adult_sex", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("adult_sex", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/adult_sex_fair.png", q)

q_CV = make_scatter_figure("german_age", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("german_age", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/german_age_fair.png", q)

q_CV = make_scatter_figure("german_sex", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("german_sex", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/german_sex_fair.png", q)

q_CV = make_scatter_figure("propublica-recidivism_race", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("propublica-recidivism_race", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/propublica-recidivism_race_fair.png", q)

q_CV = make_scatter_figure("propublica-recidivism_sex", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("propublica-recidivism_sex", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/propublica-recidivism_sex_fair.png", q)

q_CV = make_scatter_figure("propublica-violent-recidivism_race", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("propublica-violent-recidivism_race", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/propublica-violent-recidivism_race_fair.png", q)

q_CV = make_scatter_figure("propublica-violent-recidivism_sex", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("propublica-violent-recidivism_sex", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/propublica-violent-recidivism_sex_fair.png", q)

q_CV = make_scatter_figure("ricci_Race", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("ricci_Race", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
ggsave("AWS-result/ricci_fair.png", q)

q_CV = make_scatter_figure("two-gaussians_sensitive-attr", var1="CV", var2="accuracy", display = 0)
q_DI = make_scatter_figure("two-gaussians_sensitive-attr", var1="DIbinary", var2="accuracy", display = 1)
q = ggarrange(q_CV, q_DI, ncol=1, nrow=2, common.legend = TRUE, legend="right")
print(q)
...
print(p)
ggsave("AWS-result/adult_sex_sensitivity.png", p)

p = make_sensitivity_figure("adult_race_numerical-binsensitive.csv") +
  ggtitle("Adult dataset, race attribute")
print(p)
ggsave("AWS-result/adult_race_sensitivity.png", p)

p = make_sensitivity_figure("german_age_numerical-binsensitive.csv") +
  ggtitle("German dataset, age attribute")
print(p)
ggsave("AWS-result/german_age_sensitivity.png", p)

p = make_sensitivity_figure("german_sex_numerical-binsensitive.csv") +
  ggtitle("German dataset, sex attribute")
print(p)
ggsave("AWS-result/german_sex_sensitivity.png", p)

p = make_sensitivity_figure("propublica-recidivism_race_numerical-binsensitive.csv") +
  ggtitle("Propublica-recidivism dataset, race attribute")
print(p)
ggsave("AWS-result/propublica-recidivism_race_sensitivity.png", p)

p = make_sensitivity_figure("propublica-recidivism_sex_numerical-binsensitive.csv") +
  ggtitle("Propublica-recidivism dataset, sex attribute")
print(p)
ggsave("AWS-result/propublica-recidivism_sex_sensitivity.png", p)

p = make_sensitivity_figure("propublica-violent-recidivism_race_numerical-binsensitive.csv") +
  ggtitle("Propublica-violent-recidivism dataset, race attribute")
print(p)
ggsave("AWS-result/propublica-violent-recidivism_race_sensitivity.png", p)

p = make_sensitivity_figure("propublica-violent-recidivism_sex_numerical-binsensitive.csv") +
  ggtitle("Propublica-violent-recidivism dataset, sex attribute")
print(p)
ggsave("AWS-result/propublica-violent-recidivism_sex_sensitivity.png", p)

p = make_sensitivity_figure("ricci_Race_numerical-binsensitive.csv") +
  ggtitle("Ricci dataset, race attribute")
print(p)
ggsave("AWS-result/ricci_Race_sensitivity.png", p)

p = make_sensitivity_figure("two-gaussians_sensitive-attr_numerical-binsensitive.csv") +
  ggtitle("Two-gaussians_sensitive-attr dataset, sensitive attribute")
print(p)
ggsave("AWS-result/two-gaussians_sensitive-attr_sensitivity.png", p)
