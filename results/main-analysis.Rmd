...
algos_to_plot = c(
  ...
  "UGP_in_True", "UGP_dem_par_in_True",
  "ZafarEqOpp", "ZafarEqOdd")

make_scatter_figure = function(name, var1="CV", var2="accuracy", algos_plot=algos_to_plot, display="off") {
  x_var = as.name(var1)
  y_var = as.name(var2)
...
for (i in 1:N_file) {
  ...
  q_1 = make_scatter_figure(file_name[i], var1=var1_name, var2=target_name, display = "title")
  if(add_for_2){
    var2_name = paste(file_attribute[i], "-", variable_2, sep="")
  } else {
    var2_name = variable_2
  }
  q_2 = make_scatter_figure(file_name[i], var1=var2_name, var2=target_name, display = "off")
  if(add_for_3){
    var3_name = paste(file_attribute[i], "-", variable_3, sep="")
  } else {
    var3_name = variable_3
  }
  q_3 = make_scatter_figure(file_name[i], var1=var3_name, var2=target_name, display = "captain")
  q = ggarrange(q_1, q_2, q_3, ncol=1, nrow=3, common.legend = TRUE, legend="right")
  print(q)
...
```
## Algorithm independence/separation vs sufficiency (DIbinary/group-TPRDiff vs calibration)
...
for (i in 1:N_file) {
  ...
  q_2 = make_scatter_figure(file_name[i], var1=var2_name, var2=target_name, display = "captain")
  q = ggarrange(q_1, q_2, ncol=1, nrow=2, common.legend = TRUE, legend="right")
  print(q)
  export_name = paste("AWS-result/", file_name[i], "_sufficiency.png", sep="")
#  ggsave(export_name, q)
}
...
for (i in 1:N_file) {
  ...
  print(q)
  export_name = paste("AWS-result/", file_name[i], "_PR.png", sep="")
#  ggsave(export_name, q)
}
```
