...
algos_to_plot = c(
  ...
  "GP_input_False",
  "GP_input_True",
  # "FairGP_in_False_tar_0.1",
  "FairGP_in_True_tar_0.1",
  # "FairGP_in_False_tar_0.2",
  # "FairGP_in_True_tar_0.2",
  "FairGP_in_False_tar_0.3",
  "FairGP_in_True_tar_0.3",
  # "FairGP_in_False_tar_0.4",
  # "FairGP_in_True_tar_0.4",
  "FairGP_in_False_tar_0.5",
  "FairGP_in_True_tar_0.5",
  # "FairGP_in_False_tar_0.6",
  # "FairGP_in_True_tar_0.6",
  "FairGP_in_False_tar_0.7",
  "FairGP_in_True_tar_0.7",
  # "FairGP_in_False_tar_0.8",
  # "FairGP_in_True_tar_0.8",
  # "FairGP_in_False_tar_0.9",
  "FairGP_in_True_tar_0.9"
)
...
q_diff = make_scatter_figure("adult_race", var1="X0.PR.1", var2="X1.PR.1", display = "captain")
...
q_diff = make_scatter_figure("adult_sex", var1="X0.PR.2", var2="X1.PR.2", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
...
q_diff = make_scatter_figure("german_age", var1="X0.PR.1", var2="X1.PR.1", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
...
q_diff = make_scatter_figure("german_sex", var1="X0.PR.2", var2="X1.PR.2", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
...
q_diff = make_scatter_figure("propublica-recidivism_race", var1="X0.PR.1", var2="X1.PR.1", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
...
q_diff = make_scatter_figure("propublica-recidivism_sex", var1="X0.PR.2", var2="X1.PR.2", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
...
# q_diff = make_scatter_figure("propublica-violent-recidivism_race", var1="X0.PR.1", var2="X1.PR.1", display = "captain")
# q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
# print(q)
...
# q_diff = make_scatter_figure("propublica-violent-recidivism_sex", var1="X0.PR.2", var2="X1.PR.2", display = "captain")
# q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
# print(q)
...
q_diff = make_scatter_figure("ricci_race", var1="X0.PR", var2="X1.PR", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
...
q_DI = make_scatter_figure("two-gaussians_sensitive-attr", var1="X0.PR", var2="X1.PR", display = "captain")
q = ggarrange(q_CV, q_DI, q_diff, ncol=1, nrow=3, common.legend = TRUE, legend="right")
print(q)
