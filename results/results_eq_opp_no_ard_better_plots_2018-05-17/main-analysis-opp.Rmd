...
algos_to_plot = c(
  "SVM", "UGP_in_False", "UGP_eq_opp_in_True","UGP_eq_opp_in_False",
  "ZafarEqOpp")
...
make_scatter_figure = function(name, var1="race-TPRDiff", var2="accuracy", algos=algos_to_plot, display="off", statistic = "off") {
  ...
  # df$algorithm <- revalue(df$algorithm, c("UGP_in_False"="GP"))
  # df$algorithm <- revalue(df$algorithm, c("UGP_eq_opp_in_True"="FairGPopp*"))
  # df$algorithm <- revalue(df$algorithm, c("UGP_eq_opp_in_False"="FairGPopp"))
